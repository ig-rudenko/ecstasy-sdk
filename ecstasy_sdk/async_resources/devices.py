...
class AsyncDevicesResource:
    ...
    async def get_by_zabbix(self, host_id: str) -> GetDeviceByZabbix:
    ...
    async def get_session(self, *, mac: str | None = None) -> BrasPairSessionResult:
    ...
    async def get_workload_interfaces_all(
        self,
        *,
        group: str | None = None,
        vendor: str | None = None,
    ...
    async def list_actions(
        self, device_name_or_ip: str, *, page: int | None = None
    ) -> Page[UserDeviceAction]:
        """
        :param device_name_or_ip: (обязательный, path).
        :param page: A page number within the paginated result set. (необязательный, query).
    ...
    async def list_cable_diag(
        self, device_name_or_ip: str, *, port: str | None = None
    ) -> _list[dict[str, Any]]:
    ...
    async def create_collect_config(self, device_name_or_ip: str) -> CollectConfigResponse:
    ...
    async def create_commands_execute(
    ...
    async def create_commands_validate(
        self, device_name_or_ip: str, command_id: str, data: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def get_config(self, device_name_or_ip: str, file_name: str) -> dict[str, Any]:
    ...
    async def get_info(self, device_name_or_ip: str, *, page: int | None = None) -> DeviceInfo:
    ...
    async def get_interface_info(self, device_name_or_ip: str) -> InterfaceDetailInfo:
    ...
    async def get_macs(self, device_name_or_ip: str, *, port: str | None = None) -> MacListResult:
    ...
    async def list_media(self, device_name_or_ip: str, *, page: int | None = None) -> Page[DeviceMedia]:
        """
        :param device_name_or_ip: (обязательный, path).
        :param page: A page number within the paginated result set. (необязательный, query).
    ...
    async def get_pool(self, device_name_or_ip: str) -> DevicePoolStatuses:
    ...
    async def list_stats(self, device_name_or_ip: str) -> _list[dict[str, Any]]:
    ...
    async def create_viewings(self, device_name_or_ip: str) -> Any:
        """
        :param device_name_or_ip: (обязательный, path).
