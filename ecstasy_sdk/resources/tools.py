...
class ToolsResource:
    ...
    def get_ip_mac_info(self, ip_or_mac: str) -> Any:
        """Выполняет операцию Ecstasy API.
    ...
    def get_mac_vendor(self, mac: str) -> GetVendor:
        """Выполняет операцию Ecstasy API.
    ...
    def list_vlan_desc(self, *, vlan: int | None = None) -> GetVlanDesc:
        """Выполняет операцию Ecstasy API.
    ...
    def list_vlans_scan_check(self) -> Any:
        """Выполняет операцию Ecstasy API.
