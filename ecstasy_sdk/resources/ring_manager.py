...
class RingManagerResource:
    ...
    def list_transport_ring_solutions(self, ring_name: str) -> Any:
        """Выполняет операцию Ecstasy API.
    ...
    def list_transport_ring_solutions_last(self, ring_name: str) -> Any:
        """Выполняет операцию Ecstasy API.
    ...
    def list_transport_ring_status(self, ring_name: str) -> Any:
        """Выполняет операцию Ecstasy API.
